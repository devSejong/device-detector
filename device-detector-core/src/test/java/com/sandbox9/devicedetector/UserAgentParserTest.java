...
public class UserAgentParserTest {
    ...
    public void iPhone6_테스트() {
        HttpServletRequest request = generateMockRequest("Mozilla/5.0 (iPhone; CPU iPhone OS 8_0_2 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Version/8.0 Mobile/12A366 Safari/600.1.4");

        ReadableUserAgent ua = userAgentParser.parse(request);
    ...
    public void Galaxy5s_테스트() {
        HttpServletRequest request = generateMockRequest("Mozilla/5.0 (Linux; Android 5.0; SM-G900H Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2272.96 Mobile Safari/537.36");
    ...
    private HttpServletRequest generateMockRequest(String userAgentString) {
